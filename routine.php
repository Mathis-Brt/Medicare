...
<div class="wrapper">
    ...
    <nav class="navigation" style="display: flex; align-items: center;">
        ...
        if ($db_handle) {
            // Requête SQL pour récupérer les informations des laboratoires spécialisés en "Biologie de routine"
            $sql = "SELECT * FROM labo WHERE spécialité = 'Biologie de routine'";
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                echo "<p>Laboratoires spécialisés dans la biologie de routine</p>";
                echo "</div>";
            } else {
    ...
    <main class="section">
        ...
        <br>
        <img src="medecin/planning_routine.png" alt="Planning medecin" width="850" height="100">
    </main>
    <footer class="footer">
