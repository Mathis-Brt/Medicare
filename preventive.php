...
<div class="wrapper">
    ...
    <nav class="navigation" style="display: flex; align-items: center;">
        ...
        if ($db_handle) {
            // Requête SQL pour récupérer les informations des laboratoires spécialisés en "Biologie préventive"
            $sql = "SELECT * FROM labo WHERE spécialité = 'Biologie préventive'";
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                echo "<p>Laboratoires spécialisés en biologie préventive</p>";
                echo "</div>";
            } else {
    ...
    <main class="section">
        ...
        <br>
        <img src="medecin/planning_preventive.png" alt="Planning medecin" width="850" height="100">
    </main>
    <footer class="footer">
