...
if ($db_handle) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        echo "<a href='#' style='color: white;'>Gastro-Hépato-Entérologie</a>";
        echo "</div>";

        // Requête SQL pour récupérer l'e-mail du médecin
        $sql_email = "SELECT mail FROM medecinspe WHERE spécialité = 'Gastro-Hépato-Entérologie' LIMIT 1"; // Limitez à 1 car c'est pour un seul médecin
