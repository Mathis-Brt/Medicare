...
<div class="wrapper">
    ...
    <nav class="navigation" style="display: flex; align-items: center;">
        ...
        if ($db_handle) {
            // Requête SQL pour récupérer les informations des laboratoires spécialisés en "Biologie de la femme enceinte"
            $sql = "SELECT * FROM labo WHERE spécialité = 'Biologie de la femme enceinte'";
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                echo "<p>Laboratoires spécialisés dans la biologie des femmes enceintes</p>";
                echo "</div>";
            } else {
    ...
    <main class="section">
        ...
        <br>
        <img src="medecin/planning_enceinte.png" alt="Planning medecin" width="850" height="100">
    </main>
    <footer class="footer">
