    ...
    <main class="section">
        <div class="doctor-container">
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                echo "<div class='doctor-photo'><img src='medecin/medecinf.jpg' alt='Photo du Dr. " . htmlspecialchars($row['nom']) . " " . htmlspecialchars($row['prénom']) . "'></div>";
        ...
        <br>
        <img src="medecin/planning_med2.png" alt="Planning medecin" width="900" height="110">
