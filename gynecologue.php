...
if ($db_handle) {
    ...
    $sql = "SELECT * FROM medecinspe WHERE spécialité = 'Gynécologie'";
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        echo "<a href='#' style='color: white;'>Gynécologie</a>";
        echo "</div>";

        // Requête SQL pour récupérer l'e-mail du médecin
        $sql_email = "SELECT mail FROM medecinspe WHERE spécialité = 'Gynécologie' LIMIT 1"; // Limitez à 1 car c'est pour un seul médecin
        ...
        <div class="doctor-container">
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<p><strong>Gynécologue:</strong> Dr " . htmlspecialchars($row['nom']) . "</p>";
                    ...
                    echo "<img src='medecin/planning_medecin13.png' alt='Planning' class='planning-image' width='900' height='100'>";
