...
<div class="wrapper">
    ...
    if ($db_handle) {
        // Requête SQL pour récupérer les informations des médecins dermatologues
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            echo "<a href='#' style='color: white;'>Dermatologie</a>"; // Ajout du style pour la couleur blanche
            echo "</div>";
        } else {
