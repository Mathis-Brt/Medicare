...
if ($db_handle) {
    ...
    $sql = "SELECT * FROM medecinspe WHERE spécialité = 'Dermatologie'";
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        echo "<a href='#' style='color: white;'>Dermatologie</a>";
        echo "</div>";

        // Requête SQL pour récupérer l'e-mail du médecin
        $sql_email = "SELECT mail FROM medecinspe WHERE spécialité = 'Dermatologie' LIMIT 1"; // Limitez à 1 car c'est pour un seul médecin
        ...
        <div class="doctor-container">
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<p><strong>Dermatologue:</strong> Dr " . htmlspecialchars($row['nom']) . "</p>";
                    ...
                    echo "<img src='medecin/planning_med11.png' alt='Planning' class='planning-image' width='900' height='100'>";

                    // Affichage des boutons sous chaque médecin
                    echo "<div class='button-group'>";
                    echo "<button class='btn btn-primary' onclick=\"window.location.href='prendre_rendezvous.php?id=11'\">Prendre un rendez-vous</button>";
