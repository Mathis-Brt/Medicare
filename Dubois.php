...
<div class="wrapper">
    ...
    if ($db_handle) {
        // Requête SQL pour récupérer les informations du médecin avec id = 6
        $sql = "SELECT * FROM medecing WHERE id = 6";
    ...
    <main class="section">
        <div class="doctor-container">
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                echo "<div class='doctor-photo'><img src='medecin/medecinh3.png' alt='Photo du Dr. " . htmlspecialchars($row['nom']) . " " . htmlspecialchars($row['prénom']) . "'></div>";
        ...
        <br>
        <img src="medecin/planning_med6.png" alt
        ="Planning medecin" width="900" height="110">
