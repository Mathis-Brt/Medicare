...
<div class="wrapper">
    ...
    if ($db_handle) {
        ...
        $sql = "SELECT * FROM medecing WHERE id = 3";
    ...
    <main class="section">
        <div class="doctor-container">
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                echo "<div class='doctor-photo'><img src='medecin/medecinh2.jpg' alt='Photo du Dr. " . htmlspecialchars($row['nom']) . " " . htmlspecialchars($row['prénom']) . "'></div>";
