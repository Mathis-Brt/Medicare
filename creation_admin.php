...
<head>
    ...
    <title> Creation d'un Administrateur</title>
...
<div class="wrapper">
    ...
    <div class="info-box" style="display: inline-block;">
        <form action="creation_ajout_admin.php" method="post">
            <input type="email" name="mail" placeholder="Email" required>
            <input type="password" name="password" placeholder="Mot de passe" required>
            <input type="submit" value="Ajouter Administrateur" class="upload-button">
        </form>
    </div>
    </main>
