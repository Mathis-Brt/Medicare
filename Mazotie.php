...
<div class="wrapper">
    ...
    if ($db_handle) {
        ...
        $sql = "SELECT * FROM medecing WHERE id = 4";
    ...
    <main class="section">
        <div class="doctor-container">
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                echo "<div class='doctor-photo'><img src='medecin/medecinf2.jpg' alt='Photo du Dr. " . htmlspecialchars($row['nom']) . " " . htmlspecialchars($row['prénom']) . "'></div>";
        ...
        <br>
        <img src="medecin/planning_med4.png" alt="Planning medecin" width="900" height="110">
        <div class="button-group">
            <button class="btn btn-primary" onclick="window.location.href='prendre_rendezvous.php?id=4'">Prendre rendez-vous</button>
            <button class="btn btn-secondary" onclick="window.location.href='communiquer_medecin.php'">Communiquer avec le médecin</button>
            <button class="btn btn-info" onclick="window.open('generate_cv.php?id=4', '_blank')">Voir son CV</button>
        </div>
    </main>
    <footer class="footer">
